...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'blob_api/static'),
]
# STATIC_URL = '/static/'
...
DEFAULT_FILE_STORAGE = 'blob_api.storage_backends.custom_azure.AzureMediaStorage'
...
# Set a custom user model for the project
